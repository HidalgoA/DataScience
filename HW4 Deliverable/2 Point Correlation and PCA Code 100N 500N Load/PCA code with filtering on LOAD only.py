...
def create_window_with_correlation_maps_single_figure():
    ...
    # Decide how many columns (subplots) per row you want
    ncols = 4
    ...
    # Hide any extra subplots if the grid is larger than the number of images
...
# Now launch the single-figure correlation map display
