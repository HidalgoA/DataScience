...
stress_results_file = r"C:\Users\hidal\Desktop\Classes\GRAD\Data Sci Mech of Mat\HW2 Deliverable\Beam Dataset SANDBOX\RawDataDisplResults.xlsx"
...
output_file = os.path.join(script_directory, "Transformed_Displ_Data.xlsx")
...
df_long = df_merged.melt(id_vars=["Volume Fraction", "Number of Largest Holes", "Largest Hole Radius",
                         ...
                         value_name="Displacement_Values")

# Extract Displacement (1mm or 5mm) from the column name
df_long["Load"] = df_long["Material_Displacement"].apply(lambda x: 100 if "100N" in x else 500)
...
df_long = df_long[["Volume Fraction", "Load", "Youngs_Modulus", "Poisson_Ratio",
                   "Number of Largest Holes", "Largest Hole Radius", "Number of Smallest Holes",
                   "Smallest Hole Radius", "Shortest Distance to Edge", "Displacement_Values"]]
