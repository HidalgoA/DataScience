...
# Compute and display skewness before normalization
...
# Compute and display skewness after normalization
print("\nSkewness after Normalization:")
print(df_normalized.skew())

# Define independent and dependent variables
X = df_normalized[['Volume Fraction', 'Loads', 'Youngs_Modulus', 'Poisson_Ratio']]
y = df_normalized['Stress_Values']
...
# Apply MinMaxScaler to the new data
