...
skewness_before = df_standardized.skew()
print("Skewness before Log transformation:")
print(skewness_before)

# Ensure values are positive before log transformation
shift_constant = abs(df_standardized.min().min()) + 1e-6  # Shift all values to be positive non negative
